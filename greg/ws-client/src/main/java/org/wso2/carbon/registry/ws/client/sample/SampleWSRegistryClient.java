...
public class SampleWSRegistryClient {
    ...
    private static final String CARBON_HOME = "/opt/wso2greg-4.6.0";
    ...
    private static final String username = "resuser@test.com";
	...
	public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            String resourcePath = "/_system/governance/apimgt/customsequences/in/abc.xml";
